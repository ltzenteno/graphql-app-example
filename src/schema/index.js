  ...
  fields:{
    addUser:{
      ...
      resolve:(parentValue, args) => {
        ...
        return axios.post(`http://0.0.0.0:3000/users`, {
          firstName,
          age
        })
          .then(response => response.data);
    ...
    deleteUser:{
      ...
      resolve:(parentValue, args) => {
        const {id} = args;
        return axios.delete(`http://0.0.0.0:3000/users/${id}`)
          .then(response => response.data);
      }
    },
    editUser:{
      ...
      resolve:(parentValue, args) => {
        ...
        return axios.patch(`http://0.0.0.0:3000/users/${id}`, {
          firstName,
          age,
          companyId
        })
